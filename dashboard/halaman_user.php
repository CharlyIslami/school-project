...
<body id="dashboard">
    <nav class="navigation">
        ...
        <ul class="navmenu">
            ...
            <li><a href="#game" class="option">Soal-soal</a></li>
    ...
    <section class="welcome-section">
        <h1>Selamat datang kembali, <span class="user"><?php echo $_SESSION['username']; ?></h1></span>
        <p>Dashboard khusus untuk mengerjakan basic-basic matematika.</p>
    </section>
    ...
    <section class="cards-game" id="game">
        <div class="card2">
            <div class="dodge"><img src="../css/soal-soal.png" alt="dodge.game"</div>
            <h2>Soal-soal</h2>
            <p>Tujuan: Mengetahui basic-basic matematika sembari disuguhi UI UX yang interaktif</p>
            <a href="../project/soal-soal.php" class="btn">Lihat soal-soal!!!</a>
        </div>
    </section>
